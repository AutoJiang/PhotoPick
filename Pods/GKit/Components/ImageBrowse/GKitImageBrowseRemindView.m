...
@interface GKitImageBrowseRemindView ()
...
@implementation GKitImageBrowseRemindView
...
- (void)showRemindViewWithText:(NSString *)text
{
    ...
    [_maskView gkit_imagebrowse_setFrameInSuperViewCenterWithSize:CGSizeMake(size.width + 20, size.height + 40)];
    [_remindLabel gkit_imagebrowse_setFrameInSuperViewCenterWithSize:CGSizeMake(size.width, size.height)];
